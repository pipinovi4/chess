        ...
        <UtilityBoardUI>
            <div className="container-game__modes">
                ...
                <div className="container-card__modes">
                    <div onClick={() => navigate('/play/online')} className="play-online__card card">
                        <img className="image-card " src={lighning} alt="" />
                        <h2 className="title-card">Play online</h2>
                        <h3 className="text-card">
                            Play vs a person of similar skill
                        </h3>
                    </div>
                    <div onClick={() => navigate('/play/computer')} className="play-computer__card card">
                    ...
                    <div onClick={() => navigate('/friends')} className="play-friend__card card">
                        <img className="image-card" src={handshake} alt="" />
                        <div className="text-container"></div>
                        <h2 className="title-card">With friend</h2>
                        <h3 className="text-card">
